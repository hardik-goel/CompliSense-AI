...
class CompliSenseApp:
    def __init__(self, root):
        ...
        self.dpdp_portal_url = os.getenv("COMPLISENSE_DPDP_URL", "https://complisense-ai-backend.onrender.com/experience/dpdp-india")
        self.eu_portal_url = os.getenv("COMPLISENSE_EU_URL", "https://complisense-ai-backend.onrender.com/experience/eu-ai-act")
        self._build_ui()
